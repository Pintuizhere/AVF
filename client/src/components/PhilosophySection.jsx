...
export default function PhilosophySection() {
  return (
    <section className="relative bg-black text-white py-20 lg:py-32 px-4 md:px-6 overflow-hidden w-full">
      ...
      <div className="container mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20 items-center z-10 relative">
        ...
        <div className="relative h-[350px] sm:h-[450px] lg:h-[600px] w-full flex items-center justify-center mt-12 lg:mt-0 max-w-full">
          
          {/* Back subtle photo frame */}
          <div className="absolute top-4 md:top-12 right-4 md:right-12 w-40 sm:w-56 md:w-64 aspect-[4/3] bg-neutral-900 p-1 md:p-2 shadow-2xl rotate-[10deg] border border-neutral-800 opacity-60 hover:opacity-100 hover:rotate-[15deg] transition-all duration-700">
          ...
          <div className="absolute -top-2 md:-top-4 right-1/4 w-12 md:w-20 h-4 md:h-8 bg-neutral-800/80 backdrop-blur-sm rotate-[30deg] shadow-lg border border-neutral-700/50 z-20" />
