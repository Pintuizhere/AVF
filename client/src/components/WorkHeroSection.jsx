...
export default function WorkHeroSection() {
  ...
  return (
    <section className="relative min-h-[90vh] pt-32 pb-12 flex flex-col justify-end bg-black overflow-hidden border-b-[1px] border-neutral-900">
      {/* Background Image */}
      ...
      <div className="container mx-auto px-12 md:px-16 relative z-10 flex flex-col gap-12 mt-12">
      ...
      <div className="relative w-full mt-12 pt-6 pb-6 bg-[#eae3d5] z-30 shadow-[0_-15px_30px_rgba(0,0,0,0.8)] border-y-2 border-dashed border-[#b38f51]/40">
