...
export default function ProjectMediaViewer({ project }) {
  ...
  return (
    <>
      <div 
        className="relative w-full aspect-[4/3] md:aspect-[16/9] lg:aspect-[21/9] p-3 md:p-6 bg-[#0a0a0a] flex flex-col justify-center shadow-[0_10px_40px_rgba(0,0,0,0.8)] group cursor-pointer"
      ...
      >
        ...
        <div className="relative w-full h-full overflow-hidden bg-black border border-[#222]">
          ...
          <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-3 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
            <div className="w-2.5 h-2.5 rounded-full bg-gold shadow-[0_0_8px_#fca603]" />
            <div className="w-2 h-2 rounded-full bg-neutral-500 hover:bg-neutral-400 transition-colors cursor-pointer" />
            <div className="w-2 h-2 rounded-full bg-neutral-500 hover:bg-neutral-400 transition-colors cursor-pointer" />
          </div>
        </div>
      </div>
