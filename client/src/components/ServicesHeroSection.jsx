  ...
  return (
    <section className="relative h-[100dvh] w-full pt-20 pb-8 flex flex-col justify-center bg-black overflow-hidden border-b-[1px] border-neutral-900">
      ...
      <div className="container mx-auto px-6 max-w-6xl relative z-10 flex flex-col mt-4 md:mt-8">
        <div className="max-w-2xl flex flex-col items-start gap-2 md:gap-3">
          
          <h1 className="text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-bebas uppercase tracking-tighter leading-none text-white">
            Services
          </h1>
          ...
          <p className="text-xs md:text-sm font-medium tracking-wide text-neutral-300 leading-relaxed max-w-sm md:max-w-md mt-4 md:mt-8">
