...
export default function ContactHeroSection() {
  return (
    <section className="relative h-[100dvh] w-full pt-20 pb-8 flex flex-col justify-center bg-black overflow-hidden">
      {/* Background Image */}
      ...
      <div className="container mx-auto px-6 max-w-6xl relative z-10 flex flex-col mt-4 md:mt-8">
        <div className="max-w-3xl flex flex-col items-start gap-2 md:gap-3">
          ...
          <p className="text-xs md:text-sm font-medium tracking-wide text-neutral-300 leading-relaxed max-w-sm md:max-w-md mt-4 md:mt-6 relative z-20">
